...
class SearchUserHistoryAdapter (var context: Context, var friendsList : ArrayList<Friends>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
...
//            itemView.UserImage.text = friends.userName
            itemView.textView7.text = friends.userName
        }
    }
